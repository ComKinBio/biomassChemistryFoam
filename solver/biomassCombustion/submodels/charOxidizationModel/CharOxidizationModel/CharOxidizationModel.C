...
Foam::CharOxidizationModel<CloudType>::CharOxidizationModel
(
    CloudType& owner
)
:
...
Foam::CharOxidizationModel<CloudType>::CharOxidizationModel
(
    const CharOxidizationModel<CloudType>& srm
)
:
...
template<class CloudType>
void Foam::CharOxidizationModel<CloudType>::addToCharOxidizationMass
(
    const scalar dMass
)
{
...
template<class CloudType>
void Foam::CharOxidizationModel<CloudType>::info(Ostream& os)
{
...
#include "CharOxidizationModelNew.C"
